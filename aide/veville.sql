...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 07 fév. 2022 à 12:12
...
ALTER TABLE `commande`
  ...
  ADD KEY `fk_membre` (`fk_membre`),
  ADD KEY `fk_vehicule` (`fk_vehicule`),
  ADD KEY `fk_agence` (`fk_agence`);
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`fk_vehicule`) REFERENCES `vehicule` (`id_vehicule`),
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`fk_membre`) REFERENCES `membre` (`id_membre`),
  ADD CONSTRAINT `commande_ibfk_3` FOREIGN KEY (`fk_agence`) REFERENCES `agence` (`id_agence`);

--
-- Contraintes pour la table `vehicule`
--
ALTER TABLE `vehicule`
  ADD CONSTRAINT `vehicule_ibfk_1` FOREIGN KEY (`fk_agence`) REFERENCES `agence` (`id_agence`);
COMMIT;
